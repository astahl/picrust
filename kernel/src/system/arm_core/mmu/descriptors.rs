...
impl BlockDescriptor {
    ...
    pub fn with_output_address(
        ...
        match (mode, level) {
            (AddressingMode::Gran4KBAddr48bit, BlockLevel::Level0) => {
                panic!("4KB Granule has no level 0 blocks")
            }
            ...
            (AddressingMode::Gran64KBPAddr48BitVAddr48Bit, BlockLevel::Level0) => {
                panic!("64KB Granule has no level 0 blocks")
            }
            (AddressingMode::Gran64KBPAddr48BitVAddr48Bit, BlockLevel::Level1) => {
                panic!("64KB Granule has no level 1 blocks")
            }
